...
2.2 显示所有菜品列表
2.3 选择券包
2.4 购买券包并支付,下单直接唤起微信支付,不跳转到支付页。
...
待优化价格显示
1 规格材选择弹窗 价格显示的原价非折扣之后的价格会
2 使用饭票支付可再减的营销提示存在问题。 因为购物车显示的是计算菜品折扣之后的价格,而饭票支付其实不计算菜品的折扣价。需要优化
3 下单页面 优惠详细显示的不明显  会存在一定疑惑 逻辑完备性有一定缺陷


待确定字段的含义
dish  availableCopies字段
